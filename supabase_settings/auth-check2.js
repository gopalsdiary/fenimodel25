...
async function checkAuthenticationAndRedirect() {
    try {
        ...
        const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ0ZmVmeGdoZmJ0aXJmbmxidWNiIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0MDUwODc5NywiZXhwIjoyMDU2MDg0Nzk3fQ.f7jeCJfVhP3-VAw6_cw6ddiMgZE89bTTilB4LFQ4x3I';
...
function setupAuthStateListener() {
    try {
        if (typeof window.supabase !== 'undefined') {
            const supabaseUrl = 'https://vbfckjroisrhplrpqzkd.supabase.co';
            const supabaseKey = 'sb_secret_ZfFbWZQI2v8xKEC6J7elXg_B0jViYHT';
